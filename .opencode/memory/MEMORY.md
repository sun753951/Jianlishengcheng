...
- **当前阶段**: MVP Phase 2 — 品牌色+6模板排版差异化完成，Mock 生成链路跑通
...
│   ├── TemplateConfig.ets          # 6 套模板配置（STANDARD/TECHNICAL/CAMPUS/EXECUTIVE/MINIMAL/BLACK_GOLD）
...
├── style/   …# 品牌色 + 模板主题配置
│   ├── Colors.ets                   # 品牌色常量与主题色工具
│   └── TemplateThemes.ets           # 6套模板视觉主题（配色/字体/布局属性）
├── utils/                          # 工具类
